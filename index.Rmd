...
# Extract coefficients from the LASSO model as a matrix
...
## remove intercept and is_CA0 from confidence interval

# Create the results table
results_table <- data.frame(
  Predictor_Variable = variable_names,
  Coefficient = original_coefs_vector,
  CI_Lower = ci_df[, 1],  # Lower bound of confidence interval
  CI_Upper = ci_df[, 2]    # Extracting the column as a vector
)
